...
namespace TSD.WS {
    ...
    public partial class WS : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public string GetTMCForTSDJson(string guid, string data, int num_base) {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginGetTMCForTSDJson(string guid, string data, int num_base, System.AsyncCallback callback, object asyncState) {
        ...
        /// <remarks/>
        public string EndGetTMCForTSDJson(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((string)(results[0]));
        }
